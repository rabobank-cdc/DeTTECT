...
CUSTOM_DATA_SOURCES = {}
with open(os.path.dirname(__file__) +'/dettect-data/custom-data-sources.json', 'r') as input_file:
    CUSTOM_DATA_SOURCES = json.load(input_file)

DATA_SOURCES = {}
with open(os.path.dirname(__file__) +'/dettect-data/data-source-platforms.json', 'r') as input_file:
